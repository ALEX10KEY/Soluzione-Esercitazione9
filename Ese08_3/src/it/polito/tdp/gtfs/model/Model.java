...
public class Model {
	...
	private DijkstraShortestPath<Stop,DefaultEdge> dijkstraPaths;
	...
	public List<Stop> cercaPercorso(Stop partenza, Stop arrivo) {
		...
		dijkstraPaths = new DijkstraShortestPath<Stop, DefaultEdge>(graph, partenza, arrivo) ;
		
		GraphPath<Stop, DefaultEdge> path =dijkstraPaths.getPath();
